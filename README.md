...
and allow Render to connect. For a test/free setup, add `0.0.0.0/0`. For a
production setup, use a fixed outbound IP or tighter allowlist.
...
```
<a href="https://mernproject-phi-eight.vercel.app/">CLICK HERE FOR TEST</a>
